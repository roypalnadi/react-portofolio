          ...
          <div className="flex flex-col gap-2">
            <div className="flex gap-2">
              <div className="flex flex-col">
                <label
                  for="name"
                  className="mb-2 font-medium text-gray-800 dark:text-gray-200"
                >
                  Name
                </label>
                <input
            ...
            <div className="flex flex-col">
              ...
              <textarea
                ...
                className="h-32 w-full px-4 py-2 bg-space-300 border border-space-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-space-neon text-gray-800 dark:text-gray-200"
              />
            </div>
            <button
              disabled={!active}
